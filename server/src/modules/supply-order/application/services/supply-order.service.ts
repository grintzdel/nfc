...
export class SupplyOrderService {
  ...
  create(dto: SupplyOrderDomainModel.CreateSupplyOrderDto): Promise<SupplyOrderEntity> { return this.createSupplyOrderUseCase.execute(dto) }
  getAll(): Promise<SupplyOrderEntity[]> { return this.getAllSupplyOrdersUseCase.execute() }
  getById(id: string): Promise<SupplyOrderEntity> { return this.getSupplyOrderByIdUseCase.execute(id) }
  getPending(): Promise<Nullable<SupplyOrderEntity>> { return this.getPendingSupplyOrderUseCase.execute() }
  markReceived(id: string): Promise<SupplyOrderEntity> { return this.markSupplyOrderReceivedUseCase.execute(id) }
  cancel(id: string): Promise<SupplyOrderEntity> { return this.cancelSupplyOrderUseCase.execute(id) }
}
