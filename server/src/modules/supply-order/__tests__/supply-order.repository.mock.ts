...
export class SupplyOrderRepositoryMock implements ISupplyOrderRepository {
  ...
  async create(e: SupplyOrderEntity): Promise<SupplyOrderEntity> { this.create_calledWith = e; return this.create_result ?? e }
  async findById(id: string): Promise<Nullable<SupplyOrderEntity>> { this.findById_calledWith = id; return this.findById_result }
  async findAll(): Promise<SupplyOrderEntity[]> { return this.findAll_result }
  async findPending(): Promise<Nullable<SupplyOrderEntity>> { return this.findPending_result }
  async update(e: SupplyOrderEntity): Promise<SupplyOrderEntity> { this.update_calledWith = e; return this.update_result ?? e }
}
