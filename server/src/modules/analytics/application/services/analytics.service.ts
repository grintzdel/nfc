...
export class AnalyticsService {
  ...
  getParticipantsCountWithStats(): Promise<AnalyticsDomainModel.CountWithRateDto> { return this.getParticipantsCountUC.execute() }
  getBraceletsCountWithStats(): Promise<AnalyticsDomainModel.CountWithRateDto> { return this.getBraceletsCountUC.execute() }
  getRevenueWithStats(): Promise<AnalyticsDomainModel.RevenueWithRateDto> { return this.getRevenueUC.execute() }
  listBraceletsActivationByYear(year?: number): Promise<AnalyticsDomainModel.ActivationsByYearDto> { return this.listActivationsUC.execute(year) }
  listInteractionTypesWithStats(): Promise<AnalyticsDomainModel.InteractionsStatsDto> { return this.listInteractionsUC.execute() }
