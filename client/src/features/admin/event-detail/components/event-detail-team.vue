  ...
  <div class="flex flex-col rounded-lg border border-white/10 bg-[#0F172A]">
    ...
    <template v-else>
      ...
      <div class="flex items-center bg-slate-800">
        ...
        <div class="w-[130px] px-4 py-3"><span class="text-xs font-semibold tracking-wide text-slate-400">Rôle</span></div>
        <div class="w-[140px] px-4 py-3"><span class="text-xs font-semibold tracking-wide text-slate-400">Statut</span></div>
        <div class="w-[120px] px-4 py-3"><span class="text-xs font-semibold tracking-wide text-slate-400">Invité le</span></div>
      ...
      <div v-for="m in memberRows" :key="m.id" class="flex items-center border-t border-white/10">
        ...
        <div class="w-[120px] px-4 py-3 text-sm text-slate-300">{{ formatDate(m.invitedAt) }}</div>
