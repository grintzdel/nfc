...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Découvrez la gamme de bracelets NFC PULSE : pass classiques, premium et offres entreprise.',
    },
  ],
})
...
<template>
  <div>
    ...
    <section class="relative bg-pulse-bg">
      <div
        class="absolute -left-[200px] top-[15%] h-[600px] w-[600px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(124,58,237,0.09)_0%,transparent_70%)]"
      />
      <div
        class="absolute right-[5%] top-[45%] h-[500px] w-[500px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(249,115,22,0.09)_0%,transparent_70%)]"
      />
