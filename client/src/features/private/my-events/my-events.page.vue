...
<template>
  <div class="mx-auto max-w-5xl px-6 py-10 lg:py-16">
    ...
    <div v-else-if="isError" class="rounded-lg border border-red-500/30 bg-red-500/10 p-6 text-sm text-red-200">
      ...
      >
        <CardContent class="flex flex-1 flex-col gap-3 p-5">
          ...
          <div class="mt-auto flex flex-wrap items-center gap-2 pt-2">
            ...
            <RouterLink v-if="p.event" :to="`/events/${p.event.slug}`" target="_blank" rel="noopener">
